	...
	experiences: [
		{
			...
			brief:
				"For my final coop, I worked with the Front End Technologies (FET) team at Kinaxis creating robust user interfaces using ReactJS and MaterialUI in an agile development environment. I assisted in migrating the existing client UI to a new web UI by implementing new features, enhancing existing ones, and addressing customer pain points to improve user experience.",
			description:
		...
		},
		{
			...
			brief:
				"Working as a full-stack developer at Signiant, I gained lots of experience in the software development process, from the initial planning and prototyping phases to deployment and maintenance. I used modern JavaScript frameworks such as ReactJS, MaterialUI, ExpressJS, NodeJS, and Redux Toolkit to create new features and functionality.",
			description:
		...
		},
		{
			...
			brief:
				"For my second coop, I worked with the IDE and Tools team at BlackBerry QNX, gaining experience in both software development and testing, with a focus on C programming. I contributed to fixing customer-reported bugs, adding customer-driven features to the IDE, and learned various debugging and testing methodologies while doing so. Nearing the end of my term,  I began design work and prototyping for QNX’s next-generation IDE, using what I learned from client requests and the existing IDE to create the groundwork for a more streamlined experience",
			description:
		...
		},
		{
			...
			brief:
				"During my first co-op at Transport Canada, I experienced the full software development lifecycle while creating a solution to streamline security clearance requests across all departments. I was able to regularly meet with stakeholders to gather requirements, demo prototypes and show improvments with each iteration, and conduct user testing to address any UI issues",
			description:
